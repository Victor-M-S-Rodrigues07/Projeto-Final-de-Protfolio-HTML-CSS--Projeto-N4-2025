# <h1 align = "center"> Projeto Final do Site de Portfólio </h1>

<div align = "center">
<img src = ".\imgs\site-apresentacao.png" alt = "Imagem do protótipo do site de portfólio da Joana Santos" height = "600">
</div>
...
O presente projeto retrata uma proposta de portfólio com marcação via **HTML** e práticas de estilização com **CSS**. Foram utilizadas classes CSS para maior modularidade e praticidade na decoração, o uso de Flexbox a fim de organizar o *display* do site, entre outros métodos usados no mercado. <br>

A proposta do site foi realizada visando a aprovação e aprendizado prático do curso *HTML e CSS: Classes, posicionamento e Flexbox* (link nos créditos da documentação). <br>
...
Você pode acessar o protótipo do projeto no Figma clicando [aqui](https://www.figma.com/community/file/1410363576427136130/curso-2-html-e-css-classes-posicionamento-e-flexbox-portfolio). <br>
...
- Uso de Flexbox para alinhar a organização do site;
...
<a href = "https://cursos.alura.com.br/course/html-css-classes-posicionamento-flexbox"><img alt="Static Badge" src="https://img.shields.io/badge/HTML%20e%20CSS%3A%20Classes%2C%20posicionamento%20e%20Flexbox-0?style=for-the-badge&label=Curso&color=%23EA638C">
</a>
